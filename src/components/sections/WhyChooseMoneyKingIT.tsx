...
//               Agencies and brands stay with us for years because we make
//               delivery predictable, clients happy, and teams confident.
//             </p>
...
//                     <div
//                       key={index}
//                       className="bg-white rounded-xl h-16 flex items-center justify-center p-2 shadow-sm"
//                     >
//                       <Image
//                         src={logo}
//                         alt={`Client ${index + 1}`}
