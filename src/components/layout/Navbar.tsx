...
const servicesMegaData = {
  "Application Programming": {
    ...
    points: [
      { name: "Project Implementation", subslug: "project-implementation" },
      {
        ...
        subslug: "custom-software-development",
      },
      ...
      {
        name: "Cross-Platform Application Devel...",
        subslug: "cross-platform-application-development",
      },
  ...
  "Performance Marketing": {
    ...
    points: [
      ...
      {
        name: "Social Media Ads Predictive Models",
        subslug: "social-media-ads",
      },
      {
        name: "Scalable Enterprise Lead Generation",
  ...
  "Mobile App Development": {
    ...
    points: [
      ...
      {
        name: "Enterprise Grade Android Systems",
        subslug: "android-app-development",
      },
  ...
  "Cyber Security": {
    ...
    points: [
      {
        name: "Vulnerability Assessment & Audit Scans",
        subslug: "vulnerability-assessment",
      },
      {
        name: "Exploit Penetration Testing Frameworks",
        subslug: "penetration-testing",
      },
      {
        name: "Instant Automated Incident Isolation",
        subslug: "incident-response",
      },
      {
        name: "Cloud Infrastructure Compliance Validation",
        subslug: "cloud-security",
      },
    ],
  },
  "Data Management": {
    ...
    points: [
      {
        name: "Enterprise Data Warehousing Architecture",
        subslug: "data-warehousing",
      },
      {
        name: "Big Data Realtime Analytics Pipelines",
        subslug: "big-data-analytics",
      },
      {
        name: "Zero-Downtime Database Migration Engine",
        subslug: "database-migration",
      },
      {
        name: "Strict Governance & Structural Data Security",
        subslug: "data-governance",
      },
    ],
  },
  "Customer Relationship Management (CRM)": {
    ...
    points: [
      ...
      {
        name: "Salesforce Custom Customization",
        subslug: "salesforce-customization",
      },
      {
        name: "Custom UI Lead Management Panels",
        subslug: "custom-crm-portals",
      },
    ],
  },
  "Enterprise Resource Planning (ERP)": {
    ...
    points: [
      {
        name: "Supply Chain Operations Modules",
        subslug: "supply-chain-systems",
      },
      {
        name: "HR Management Systems & Portals",
        subslug: "hr-management-portals",
      },
      {
        name: "Financial Automation Ledgers",
        subslug: "financial-modules-integration",
      },
    ],
  },
  "Artificial Intelligence": {
    ...
    points: [
      {
        name: "Generative AI System Integrations",
        subslug: "gen-ai-integrations",
      },
      {
        name: "Predictive Analytics & Forecasting",
        subslug: "predictive-analytics",
      },
      {
        name: "NLP Classification Architectures",
        subslug: "nlp-architectures",
      },
      {
        name: "Custom LLM Weight Tuning Pipelines",
        subslug: "custom-llm-training",
      },
    ],
  },
    ...
    points: [
      {
        ...
        subslug: "cloud-infrastructure-scaling",
      },
      {
        name: "Continuous CI/CD Automation Pipelines",
        subslug: "ci-cd-pipeline-setup",
      },
      {
        name: "Kubernetes Microservices Mesh Control",
        subslug: "kubernetes-clustering",
      },
    ],
  },
};
...
export default function Navbar() {
  ...
  const [activeTab, setActiveTab] = useState<MegaKeys>(
    "Application Programming",
  );
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-zinc-950 border-b border-zinc-800">
      ...
      <div className="flex items-center justify-between px-6 md:px-12 py-3">
        {/* Circle Logo with Company Name */}
        <Link
          href="/"
          className="flex items-center gap-4 shrink-0 select-none no-underline group ml-2 md:ml-4"
        >
          <div className="relative w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden shadow-emerald-500/10 shrink-0">
            <Image
              src="/about/logo.jpeg"
              alt="Skky Loom Logo"
              fill
        ...
        <ul className="hidden md:flex items-center gap-8 text-zinc-300 font-medium ml-auto mr-8">
          ...
          <li ref={dropdownRef} className="relative py-2">
            <button
              ...
              className={`hover:text-emerald-400 transition cursor-pointer flex items-center gap-1 bg-transparent border-none text-zinc-300 font-medium focus:outline-none select-none ${
                isMegaOpen ? "text-emerald-400" : ""
              }`}
            >
              <span>Services</span>
              <ChevronDown
                className={`w-4 h-4 transition-transform duration-300 ${
                  isMegaOpen ? "rotate-180 text-emerald-400" : ""
                }`}
              />
            </button>
            {isMegaOpen && (
        ...
        <Link
          href="/contact"
          className="hidden md:block bg-emerald-500 hover:bg-emerald-600 text-zinc-900 px-5 py-2.5 rounded-full font-bold transition text-center text-sm"
        >
          Contact Us
        </Link>
          ...
          <div className="px-6 py-6 flex flex-col space-y-4">
            ...
            <div className="border-b border-zinc-900 py-2">
              <button
                onClick={() =>
                  setMobileActiveTab(
                    mobileActiveTab ? null : "Application Programming",
                  )
                }
              ...
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 transition-transform duration-300 ${
                    mobileActiveTab ? "rotate-180 text-emerald-400" : ""
                  }`}
                />
              </button>
                ...
                <div className="mt-3 pl-2 space-y-4 animate-in fade-in duration-200">
                  {Object.keys(servicesMegaData).map((category) => {
                    ...
                    return (
                      <div
                        key={category}
                        className="space-y-2 bg-zinc-900/40 p-3 rounded-xl border border-zinc-900"
                      >
                        ...
                        <div className="grid grid-cols-1 gap-2 pt-1">
                          {data.points.map((point, index) => (
                            <button
                              key={index}
                              onClick={() =>
                                handleSubItemClick(data.slug, point.subslug)
                              }
