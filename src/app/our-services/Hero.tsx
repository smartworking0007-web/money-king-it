  ...
  return (
    <section className="pt-32 pb-20 px-6 text-center bg-white border-b border-zinc-200">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto">
        ...
        <p className="text-zinc-600 text-lg mb-10 max-w-2xl mx-auto">Skky Loom Digital Technology Pvt. Ltd. delivers innovative software, AI, cybersecurity, cloud, and digital transformation services.</p>
