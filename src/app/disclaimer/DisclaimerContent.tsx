...
const sections = [
  { icon: FileText, title: "General Information", text: "The information provided by Skky Loom Digital Technology Pvt. Ltd. Solutions on this website is for general informational purposes only." },
  ...
  { icon: AlertCircle, title: "Limitation of Liability", text: "Skky Loom Digital Technology Pvt. Ltd. Solutions shall not be liable for any indirect, incidental, or consequential damages arising from site use." },
  ...
  { icon: Cpu, title: "Intellectual Property", text: "All content, logos, and software architecture are the exclusive property of Skky Loom Digital Technology Pvt. Ltd.s." },
