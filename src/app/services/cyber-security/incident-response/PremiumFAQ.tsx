...
export default function PremiumFAQ() {
  const f = [{q: "What is Auto-Isolation?", a: "AI identifies malicious activity and instantly cuts network access to endpoints."}, {q: "MTTR?", a: "Mean Time To Respond reduced from hours to minutes."}, {q: "SOC Coverage?", a: "We provide 24/7/365 global monitoring."}];
  return (
