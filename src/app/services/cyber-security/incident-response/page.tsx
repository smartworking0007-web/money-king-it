...
import SecurityServicesGrid from "./SecurityServicesGrid";
import ContainmentFlowGrid from "./ContainmentFlowGrid";
import AutomatedIncidentResponseOrchestration from "./AutomatedIncidentResponseOrchestration";
  ...
  return (
    <>
      <section className="relative w-full min-h-[85vh] sm:min-h-[90vh] bg-black text-white overflow-hidden flex items-center py-16 sm:py-20 px-5 sm:px-8 md:px-12 lg:px-16">
        ...
        {/* Main Content Container - Explicitly left-aligned */}
        <div className="relative z-10 mx-auto max-w-7xl w-full flex justify-start">
          <div className="max-w-2xl w-full flex flex-col space-y-6 text-left items-start">
            ...
            >
              Instant Automated Incident <br />
              Response & Threat Isolation
            </Text>
            ...
            >
              Detect, isolate, and contain cyber threats in real time using
              AI-powered <br className="hidden sm:inline" />
              workflows and enterprise security orchestration.
            </Text>
      ...
      <ContainmentFlowGrid />
      <AutomatedIncidentResponseOrchestration />
