...
import EnterpriseCloudAndInfrastructureSecurity from "./EnterpriseCloudAndInfrastructureSecurity";
import CyberSecurityFrameworkGrid from "./CyberSecurityFrameworkGrid";
import EnterpriseSecurityAndDataGovernance from "./EnterpriseSecurityAndDataGovernance";
import ThreatAnalysisAndIntelligenceManagement from "./ThreatAnalysisAndIntelligenceManagement";
...
export default function Page() {
  return (
    <>
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full flex justify-start">
          <div className="max-w-2xl w-full flex flex-col space-y-5 sm:space-y-6 text-left items-start">
            <div className="w-full">
              ...
              >
                Enterprise Cloud Security & Compliance Validation
              </Text>
            </div>
            ...
            <div className="w-full">
              ...
              >
                Secure your infrastructure with compliance-driven frameworks,
                governance controls, and continuous multi-cloud monitoring.
              </Text>
            </div>
      ...
      <EnterpriseCloudAndInfrastructureSecurity />
      <CyberSecurityFrameworkGrid />
      <EnterpriseSecurityAndDataGovernance />
      <ThreatAnalysisAndIntelligenceManagement />
