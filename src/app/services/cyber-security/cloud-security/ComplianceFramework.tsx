...
export default function ComplianceFramework() {
  const f = ["Discovery", "Assessment", "Gap Analysis", "Governance", "Validation", "Continuous Monitoring"];
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto"><Text variant="h2" className="text-center mb-10">Framework</Text>
