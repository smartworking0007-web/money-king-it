// File Name: ArchitectureRoadmapGrid.tsx

import React from "react";
import Image from "next/image";
import Text from "@/components/ui/Text";

const ARCHITECTURE_ROADMAP_STEPS = [
  {
    number: "01",
    title: "Assessment",
    description:
      "Evaluating infrastructure readiness, container dependencies, and current monolithic limitations.",
  },
  {
    number: "02",
    title: "Design",
    description:
      "Architecting microservices boundaries, namespace policies, and cluster topologies.",
  },
  {
    number: "03",
    title: "Provisioning",
    description:
      "Setting up worker nodes, control planes, and cloud-native infrastructure components.",
  },
  {
    number: "04",
    title: "Deployment",
    description:
      "Rolling out container workloads, Kubernetes manifests, and pod configurations.",
  },
  {
    number: "05",
    title: "Mesh Int.",
    description:
      "Integrating service mesh layers for secure mTLS, traffic splitting, and observability.",
  },
  {
    number: "06",
    title: "Security",
    description:
      "Enforcing RBAC policies, network segmentation, and runtime vulnerability scanners.",
  },
  {
    number: "07",
    title: "Monitoring",
    description:
      "Configuring telemetry dashboards, Prometheus metrics, and distributed log tracing.",
  },
  {
    number: "08",
    title: "Optimization",
    description:
      "Fine-tuning autoscaling rules, resource limits, and cluster performance efficiency.",
  },
];

export default function ArchitectureRoadmapGrid() {
  return (
    <section className="relative w-full bg-[#0a0a0a] text-white overflow-hidden py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 border-t border-white/10">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Image
          src="/services/7.png"
          alt="architecture roadmap background"
          fill
          priority
          sizes="100vw"
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
          {ARCHITECTURE_ROADMAP_STEPS.map((step, index) => (
            <div
              key={index}
