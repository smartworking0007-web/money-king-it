...
export default function PremiumFAQ() {
  const f = [{q: "Why Native Android?", a: "Best performance and hardware integration."}, {q: "Timeline?", a: "Custom enterprise apps in 4-6 months."}, {q: "Support?", a: "Full Play Store lifecycle management."}];
  return (
