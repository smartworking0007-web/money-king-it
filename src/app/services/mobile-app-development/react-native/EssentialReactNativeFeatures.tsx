// File Name: EssentialReactNativeFeatures.tsx
...
const ESSENTIAL_FEATURES = [
  {
    ...
    description: "Write Once, Deploy Seamlessly Across iOS & Android",
    keywords:
      "Single Codebase Development, Cross-Platform Deployment, Code Reusability React Native",
    icon: Code2,
  },
  {
    title: "Native Speed",
    description: "Near-Native Performance Powered by Hermes JS Engine",
    keywords:
      "React Native Hermes Engine, Near-Native Mobile Speed, 60FPS UI Performance",
    icon: Zap,
  },
  {
    title: "Push Notifs",
    description: "Instant Push Notifications via Firebase FCM & OneSignal",
    keywords:
      "Firebase FCM Notifications, OneSignal Push Integration, Real-Time Customer Engagement",
    icon: Bell,
  },
  {
    title: "Offline Mode",
    description: "Uninterrupted App Access with Local Data Caching",
    keywords:
      "React Native Offline Mode, Local Caching MMKV, WatermelonDB Storage",
    icon: WifiOff,
  },
  {
    title: "Auth Security",
    description: "Biometric & Secure Keychain/Keystore Authentication",
    keywords:
      "Biometric Auth Integration, React Native Keychain Security, OAuth 2.0 Mobile Login",
    icon: ShieldCheck,
  },
  {
    title: "Real-Time Sync",
    description: "Instant Data Updates via WebSockets & GraphQL Subscriptions",
    keywords:
      "Real-Time Data Sync, WebSocket React Native, GraphQL Subscriptions",
    icon: RefreshCcw,
  },
];

export default function EssentialReactNativeFeatures() {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="text-center max-w-xl mx-auto mb-8 sm:mb-10">
          ...
          <p className="text-zinc-400 text-[11px] sm:text-xs font-normal leading-relaxed max-w-md mx-auto">
            Discover the powerful features that make React Native the ultimate
            framework for scalable mobile apps.
          </p>
        </div>

        {/* Responsive Compact Grid Layout */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {ESSENTIAL_FEATURES.map((item, index) => {
