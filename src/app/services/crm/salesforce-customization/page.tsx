...
import EnterpriseSalesforceSolutions from "./EnterpriseSalesforceSolutions";
import AutomationFramework from "./AutomationFramework";
import AutomatedEnterpriseWorkflows from "./AutomatedEnterpriseWorkflows";
...
export default function BigDataAnalyticsHero() {
  return (
    <>
      ...
      {/* Appended Sections */}
      <EnterpriseSalesforceSolutions />
      <AutomationFramework />
      <AutomatedEnterpriseWorkflows />
