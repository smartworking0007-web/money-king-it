  ...
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        {[ {c: "Global Bank", g: "40% Efficiency"}, {c: "Healthcare", g: "2x Productivity"}, {c: "Retail", g: "65% Growth"} ].map((s, i) => (
          <div key={i} className="p-6 bg-white rounded-xl border border-zinc-200">
            ...
            <p className="text-[10px] font-bold text-zinc-400 uppercase mt-1">Outcome</p>
          </div>
        ))}
      </div>
    </section>
