...
const workflowGovernanceItems = [
  {
    id: "01",
    title: "Lead Assignment",
    subtext:
      "Automated Round-Robin Lead Routing, Territory Mapping & SLA Enforcement",
    geoKeywords:
      "Automated Lead Assignment Rules, Round-Robin Lead Routing, Territory Management Automation",
  },
  {
    id: "02",
    title: "Sales Process",
    subtext:
      "End-to-End Pipeline Automation, Stage Exit Criteria & Task Orchestration",
    geoKeywords:
      "Enterprise Sales Process Automation, CRM Stage Gating, Sales Execution Workflows",
  },
  {
    id: "03",
    title: "Approval Flows",
    subtext:
      "Multi-Tier Hierarchical Approvals for Discounts, Contracts & Governance",
    geoKeywords:
      "Automated Approval Workflows, Discount & Contract Approval Trees, Governance & Risk Controls",
  },
  {
    id: "04",
    title: "Support Flows",
    subtext:
      "Automated Helpdesk Escalations, Priority Ticket Routing & Omnichannel Support",
    geoKeywords:
      "Customer Support Workflows, Helpdesk Ticket Automation, SLA Escalation Rules",
  },
  {
    id: "05",
    title: "Case Management",
    subtext:
      "Centralized Case Lifecycle Tracking, Knowledge Base Integration & Auto-Closure",
    geoKeywords:
      "Enterprise Case Management, Customer Issue Lifecycle Tracking, Automated Case Resolution",
  },
  {
    id: "06",
    title: "Quote Auto",
    subtext:
      "Automated Dynamic Pricing, Proposal Generation & E-Signature Hand-off",
    geoKeywords:
      "Automated CPQ Quote Generation, Dynamic Pricing Workflows, Automated Contract Proposals",
  },
  {
    id: "07",
    title: "Revenue Track",
    subtext:
      "Real-Time Contract Value Sync, Recurring Revenue Tracking & Recognition",
    geoKeywords:
      "Revenue Recognition Workflows, Real-Time ARR/MRR Tracking, Enterprise Billing Automation",
  },
  {
    id: "08",
    title: "Performance Analytics",
    subtext:
      "Process Bottleneck Analysis, Operational KPI Metrics & Resource Utilization",
    geoKeywords:
      "Enterprise Process Performance Metrics, Workflow Bottleneck Optimization, Operational Analytics",
  },
];

export default function AutomatedEnterpriseWorkflows() {
  return (
    <section className="relative w-full py-10 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-black text-white overflow-hidden flex items-center justify-center min-h-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <div className="max-w-3xl mx-auto mb-8 sm:mb-14">
          ...
          >
            Automated Enterprise Workflows &amp; Process Governance
          </Text>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 w-full">
          {workflowGovernanceItems.map((item) => (
            <div
              key={item.id}
