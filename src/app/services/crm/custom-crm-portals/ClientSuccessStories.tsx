  ...
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        {[ {c: "Real Estate", g: "45% Faster"}, {c: "Fintech", g: "3x Growth"}, {c: "SaaS Scaleup", g: "70% Conversion"} ].map((s, i) => (
          <div key={i} className="p-6 bg-white rounded-xl border border-zinc-200">
            ...
            <p className="text-[10px] font-bold text-zinc-400 uppercase mt-1">Growth Outcome</p>
          </div>
        ))}
      </div>
    </section>
