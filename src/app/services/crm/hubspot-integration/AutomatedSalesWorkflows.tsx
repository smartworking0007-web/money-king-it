...
const workflowItems = [
  {
    ...
    subtext: "Automated Lead Scoring, BANT Criteria Assessment & Routing",
    geoKeywords:
      "Automated Lead Qualification, Predictive Lead Scoring, MQL to SQL Workflow",
  },
  {
    id: "02",
    title: "Auto Follow-Ups",
    subtext: "Multi-Channel Drip Sequences & Behavioral Email Triggers",
    geoKeywords:
      "Automated Sales Sequences, Email Follow-Up Automation, Behavioral Nurturing",
  },
  {
    id: "03",
    title: "Deal Management",
    subtext: "Dynamic Deal Stage Movement, Probability Rules & Approval Gates",
    geoKeywords:
      "Sales Pipeline Management, Automated Deal Tracking, CRM Deal Stage Workflows",
  },
  {
    id: "04",
    title: "Task Automation",
    subtext: "Automated Task Creation, Meeting Scheduling & SLA Reminders",
    geoKeywords:
      "Sales Task Automation, Automated Meeting Scheduling, Sales Rep Productivity",
  },
  {
    id: "05",
    title: "Sales Notifications",
    subtext: "Real-Time Slack, Teams, and Email Alerts on Prospect Activity",
    geoKeywords:
      "Real-Time Sales Alerts, Slack & CRM Integration, Prospect Activity Notifications",
  },
  {
    id: "06",
    title: "Revenue Forecast",
    subtext:
      "AI-Driven Revenue Pipeline Forecasting & Win Probability Analytics",
    geoKeywords:
      "AI Revenue Forecasting, Sales Pipeline Analytics, Predictive Sales Velocity",
  },
  {
    id: "07",
    title: "Journey Tracking",
    subtext: "Full-Funnel Buyer Journey Visibility & Multi-Touch Attribution",
    geoKeywords:
      "Buyer Journey Mapping, Full-Funnel Sales Tracking, Multi-Touch Sales Attribution",
  },
];

export default function AutomatedSalesWorkflows() {
  return (
    <section className="relative w-full py-10 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-black text-white overflow-hidden flex items-center justify-center min-h-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <div className="max-w-3xl mx-auto mb-8 sm:mb-14">
          ...
          >
            Automated Sales Workflows &amp; Pipeline Optimization
          </Text>
        </div>

        {/* Responsive Grid Layout (Mobile: 1 col, Tablet: 2 cols, Laptop: 3/4 cols) */}
