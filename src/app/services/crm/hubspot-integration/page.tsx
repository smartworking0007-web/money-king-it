...
import EnterpriseHubspotServices from "./EnterpriseHubspotServices";
import PipelineAutomationFramework from "./PipelineAutomationFramework";
import AutomatedSalesWorkflows from "./AutomatedSalesWorkflows";
import AutomatedLeadNurturing from "./AutomatedLeadNurturing";
...
export default function BigDataAnalyticsHero() {
  return (
    <>
      ...
      <EnterpriseHubspotServices />
      <PipelineAutomationFramework />
      <AutomatedSalesWorkflows />
