...
const nurturingFrameworkItems = [
  {
    id: "01",
    title: "Email Sequences",
    subtext: "Automated Drip Campaigns & Dynamic Content Personalization",
    geoKeywords:
      "Automated Email Drip Sequences, Lead Nurturing Email Workflows, Dynamic Email Personalization",
  },
  {
    id: "02",
    title: "Lead Scoring",
    subtext: "Explicit & Implicit Scoring Models for MQL/SQL Qualification",
    geoKeywords:
      "Predictive Lead Scoring Models, MQL SQL Lead Qualification, Behavioral Lead Scoring",
  },
  {
    id: "03",
    title: "Behavior Tracking",
    subtext: "Page View, Content Download & Link Click Activity Monitoring",
    geoKeywords:
      "Buyer Behavior Tracking, Prospect Intent Data Analysis, Web Engagement Monitoring",
  },
  {
    id: "04",
    title: "Dynamic Segmentation",
    subtext:
      "Real-Time Audience Categorization Based on Demographics & Actions",
    geoKeywords:
      "Dynamic CRM Segmentation, Behavioral Audience Lists, Personalized Lead Categorization",
  },
  {
    id: "05",
    title: "Multi-Channel Campaigns",
    subtext: "Omnichannel Nurturing Across Email, SMS & Retargeting Ads",
    geoKeywords:
      "Omnichannel Lead Nurturing, Multi-Touch Campaign Automation, Targeted Nurturing Workflows",
  },
  {
    id: "06",
    title: "Conversion Automation",
    subtext: "Automated Demo Booking, Form Hand-offs & Pipeline Stage Triggers",
    geoKeywords:
      "Automated Conversion Funnels, Meeting Scheduling Workflows, Pipeline Conversion Triggers",
  },
  {
    id: "07",
    title: "Engagement Tracking",
    subtext:
      "Intent Detection & Automated Re-engagement Triggers for Cold Leads",
    geoKeywords:
      "Lead Engagement Analytics, Cold Lead Re-engagement Workflows, Prospect Interaction Tracking",
  },
  {
    id: "08",
    title: "Customer Retention",
    subtext: "Post-Purchase Onboarding, Upsell Triggers & Churn Prevention",
    geoKeywords:
      "Automated Customer Retention, Customer Onboarding Workflows, SaaS Churn Reduction",
  },
];

export default function AutomatedLeadNurturing() {
  return (
    <section className="relative w-full py-10 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-black text-white overflow-hidden flex items-center justify-center min-h-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <div className="max-w-3xl mx-auto mb-8 sm:mb-14">
          ...
          >
            Automated Lead Nurturing &amp; Engagement Framework
          </Text>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 w-full">
          {nurturingFrameworkItems.map((item) => (
            <div
              key={item.id}
