  ...
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        {[ 
          {c: "Global Fintech", g: "80% Automation"}, 
          {c: "Healthcare System", g: "2x Efficiency"}, 
          {c: "Retail Giant", g: "65% Cost Cut"} 
        ].map((s, i) => (
          <div key={i} className="p-6 bg-white rounded-xl border border-zinc-200 shadow-sm">
            ...
            <p className="text-[10px] font-bold text-zinc-400 uppercase mt-1">AI Transformation</p>
          </div>
        ))}
      </div>
    </section>
