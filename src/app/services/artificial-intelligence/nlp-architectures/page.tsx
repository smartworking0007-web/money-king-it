// File Name: NlpClassificationHero.tsx
...
import EnterpriseNlpSolutionsGrid from "./EnterpriseNlpSolutionsGrid";
import NlpFrameworkTimelineGrid from "./NlpFrameworkTimelineGrid";
import EnterpriseModelArchitecturesGrid from "./EnterpriseModelArchitecturesGrid";

/**
 * NlpClassificationHero.tsx
 * Fully responsive hero section optimized for mobile and desktop screens with left-aligned content.
 */

export default function NlpClassificationHero() {
  return (
    <main className="w-full bg-black min-h-screen overflow-x-hidden">
      <section className="relative w-full min-h-[85vh] sm:min-h-[90vh] bg-black text-white overflow-hidden flex items-center py-16 sm:py-20 px-5 sm:px-8 md:px-12 lg:px-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full flex justify-start">
          <div className="max-w-2xl w-full flex flex-col space-y-6 text-left items-start">
            ...
            >
              NLP Classification Architectures
            </Text>
            ...
            >
              Build intelligent language understanding systems using advanced
              NLP architectures for text classification and enterprise
              automation.
            </Text>
      ...
      <EnterpriseNlpSolutionsGrid />
      <NlpFrameworkTimelineGrid />
      <EnterpriseModelArchitecturesGrid />
