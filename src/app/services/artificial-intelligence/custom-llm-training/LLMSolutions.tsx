export default function LLMSolutions() {
  const sol = ["Enterprise Dev", "Domain AI", "Fine-Tuning", "RAG Systems", "Knowledge AI", "Copilot Dev", "Multi-Agent AI", "Foundation Models", "AI Automation", "Optimization"];
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto">
      <h2 className="text-2xl font-black text-center mb-10 text-[#0F172A]">LLM Solutions</h2>
