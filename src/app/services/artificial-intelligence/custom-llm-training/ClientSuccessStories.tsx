    ...
    <section className="py-12 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        {[ 
          {
            c: "Global Banking", 
            challenge: "Legacy model inefficiency", 
            g: "+92% Accuracy", 
            outcome: "Automated core banking AI"
          }, 
          {
            c: "Fintech Leader", 
            challenge: "High inference latency", 
            g: "+65% Speed", 
            outcome: "Real-time AI throughput"
          }, 
          {
            c: "Healthcare Group", 
            challenge: "Domain data silos", 
            g: "+80% Growth", 
            outcome: "Precision AI diagnostics"
          } 
        ].map((s, i) => (
