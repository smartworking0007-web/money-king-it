...
import EnterpriseLlmSolutionsGrid from "./EnterpriseLlmSolutionsGrid";
import PipelineWorkflowGrid from "./PipelineWorkflowGrid";
import AiOptimizationGrid from "./AiOptimizationGrid";
...
export default function NlpClassificationHero() {
  return (
    <main className="w-full bg-black min-h-screen overflow-x-hidden">
      <section className="relative w-full min-h-[85vh] sm:min-h-[90vh] bg-black text-white overflow-hidden flex items-center py-16 sm:py-20 px-5 sm:px-8 md:px-12 lg:px-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full flex justify-start">
          <div className="max-w-2xl w-full flex flex-col space-y-6 text-left items-start">
            ...
            >
              Custom LLM Weight Tuning Pipelines
            </Text>
            ...
            >
              Build domain-specific large language models with advanced
              fine-tuning pipelines and enterprise AI infrastructure.
            </Text>
      ...
      <EnterpriseLlmSolutionsGrid />
      <PipelineWorkflowGrid />
      <AiOptimizationGrid />
