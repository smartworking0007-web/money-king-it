// File Name: leadGrowthMarquee.tsx
...
const GROWTH_IMAGES = [
  { src: "/lead/1.png", alt: "Lead Step 1" },
  { src: "/lead/2.png", alt: "Lead Step 2" },
  { src: "/lead/3.png", alt: "Lead Step 3" },
  { src: "/lead/4.png", alt: "Lead Step 4" },
  { src: "/lead/5.png", alt: "Lead Step 5" },
  { src: "/lead/6.png", alt: "Lead Step 6" },
];

export default function LeadGrowthMarquee() {
  ...
  return (
    <section className="relative w-full bg-black text-white overflow-hidden py-12 md:py-20 border-t border-white/10 flex flex-col items-center justify-center min-h-[40vh]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/seo/3.png"
          alt="growth framework background"
          fill
          priority
          sizes="100vw"
