export default function FinanceSolutions() {
  const sol = ["General Ledger", "Accounts Payable", "Accounts Rec.", "Fin Reporting", "Budget Planning", "Cash Flow", "Expense Tracking", "Tax Mgmt", "Audit Ready", "Compliance"];
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto">
      <h2 className="text-2xl font-black text-center mb-10 text-[#0F172A]">Finance Solutions</h2>
