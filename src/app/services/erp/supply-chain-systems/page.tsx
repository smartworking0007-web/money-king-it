...
import EnterpriseSupplyChainSolutions from "./EnterpriseSupplyChainSolutions";
import StrategicProcurementSourcing from "./StrategicProcurementSourcing";
import ProcurementWorkflowFramework from "./ProcurementWorkflowFramework";
...
export default function BigDataAnalyticsHero() {
  return (
    <>
      <section className="relative w-full min-h-[85vh] sm:min-h-[90vh] bg-black text-white overflow-hidden flex items-center py-16 sm:py-20 px-5 sm:px-8 md:px-12 lg:px-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full flex justify-start">
          <div className="max-w-2xl w-full flex flex-col space-y-6 text-left items-start">
            ...
            >
              Optimize procurement, inventory, and logistics through intelligent
              ERP-driven automation and real-time operational visibility.
            </Text>
      ...
      {/* Appended Sections */}
      <EnterpriseSupplyChainSolutions />
      <StrategicProcurementSourcing />
      <ProcurementWorkflowFramework />
