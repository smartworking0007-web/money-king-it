...
const procurementServices = [
  {
    id: "01",
    title: "Requisition Automation",
    subtext:
      "Automated Purchase Request Ingestion, Catalog Integration & Budget Check Controls",
    geoKeywords:
      "Automated Purchase Requisitions, PR to PO Automation, Enterprise E-Procurement Catalogs",
  },
  {
    id: "02",
    title: "Supplier Selection",
    subtext:
      "AI-Powered Vendor Matching, RFP Management & Multi-Factor Bidding Scoring",
    geoKeywords:
      "Automated Supplier Sourcing, Vendor Selection Software, RFP Management Automation",
  },
  {
    id: "03",
    title: "Contract Lifecycle Management (CLM)",
    subtext:
      "Automated Contract Creation, Milestone Tracking, Compliance & Renewal Alerts",
    geoKeywords:
      "Procurement Contract Management, Automated SLA Compliance, Vendor Lifecycle Contracts",
  },
  {
    id: "04",
    title: "Purchase Order Automation",
    subtext:
      "Touchless PO Generation, ERP Ledger Sync & Dynamic Vendor Delivery Triggers",
    geoKeywords:
      "Touchless Purchase Order Automation, Automated PO Dispatch, ERP Integrated Purchase Orders",
  },
  {
    id: "05",
    title: "Supplier Evaluation",
    subtext:
      "Performance Scorecards, On-Time Delivery Metrics & Risk Assessment Modeling",
    geoKeywords:
      "Vendor Performance Metrics, Supplier Risk Evaluation, Procurement Scorecard Automation",
  },
  {
    id: "06",
    title: "Cost Optimization",
    subtext:
      "Spend Analytics, Maverick Spend Detection & Automated Volume Discount Triggers",
    geoKeywords:
      "Procurement Cost Reduction, Spend Leakage Analytics, Enterprise Volume Discounting",
  },
  {
    id: "07",
    title: "Approval Workflows",
    subtext:
      "Dynamic Financial Threshold Routing, Multi-Level Hierarchy Approvals & Audit Trails",
    geoKeywords:
      "Automated Purchase Approvals, Procurement Audit Trails, Financial Hierarchy Approval Rules",
  },
  {
    id: "08",
    title: "Procurement Analytics",
    subtext:
      "Executive Spend Visibility, Category Analysis & Real-Time Savings Dashboards",
    geoKeywords:
      "Procurement Spend Analytics, Category Management Analytics, Procurement KPI Dashboards",
  },
];

export default function StrategicProcurementSourcing() {
  return (
    <section className="relative w-full py-10 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-black text-white overflow-hidden flex items-center justify-center min-h-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <div className="max-w-3xl mx-auto mb-8 sm:mb-14">
          ...
          >
            Strategic Procurement &amp; Automated Sourcing Solutions
          </Text>
        </div>
