...
import NextGenHrWorkforceSolutions from "./NextGenHrWorkforceSolutions";
import EmployeeLifecycleFramework from "./EmployeeLifecycleFramework";
import EnterprisePayrollComplianceSolutions from "./EnterprisePayrollComplianceSolutions";
...
export default function WebsiteDevelopmentHero() {
  return (
    <>
      <section className="relative w-full min-h-[85vh] sm:min-h-[90vh] bg-black text-white overflow-hidden flex items-center py-16 sm:py-20 px-5 sm:px-8 md:px-12 lg:px-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full flex justify-center lg:justify-end">
          <div className="max-w-2xl w-full flex flex-col space-y-6 text-left items-start">
            ...
            >
              Digitize workforce management with intelligent HR platforms,
              automated payroll, and intuitive employee self-service
              experiences.
            </Text>
      ...
      <NextGenHrWorkforceSolutions />
      <EmployeeLifecycleFramework />
      <EnterprisePayrollComplianceSolutions />
