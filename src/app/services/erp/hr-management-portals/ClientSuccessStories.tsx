  ...
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        {[ 
          {c: "Fintech Startup", g: "+40% Productivity"}, 
          {c: "Healthcare Group", g: "+30% Satisfaction"}, 
          {c: "Enterprise Retail", g: "+50% Hiring Speed"} 
        ].map((s, i) => (
          <div key={i} className="p-6 bg-white rounded-xl border border-zinc-200 shadow-sm">
            ...
            <p className="text-[10px] font-bold text-zinc-400 uppercase mt-1">HR Transformation</p>
          </div>
        ))}
      </div>
    </section>
