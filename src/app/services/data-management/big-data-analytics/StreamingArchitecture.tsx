...
export default function StreamingArchitecture() {
  const f = ["Collection", "Streaming", "Processing", "Transformation", "AI Insights", "Decision"];
  return (
    <section className="py-12 px-6 max-w-5xl mx-auto"><Text variant="h2" className="text-center mb-10">Pipeline Architecture</Text>
