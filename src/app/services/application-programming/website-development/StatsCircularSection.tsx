...
const STATS_DATA = [
  {
    number: "5,000+",
    label: "Students",
    ringText: "Global Student Community • Empowering Next-Gen •",
  },
  {
    number: "100+",
    label: "Drives",
    ringText: "Campus Placement Drives • Corporate Hiring •",
  },
  {
    number: "95%",
    label: "Placement",
    ringText: "Success Rate • Top Tier Careers •",
  },
  {
    number: "50+",
    label: "Partnerships",
      ...
      <div className="mx-auto max-w-350">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start">
            <h3 className="text-3xl sm:text-4xl md:text-[48px] font-bold tracking-tight text-white leading-[1.1] mb-6">
            ...
            {STATS_DATA.map((item, index) => (
              ...
              >
                ...
                <div className="relative w-32 h-32 sm:w-36 sm:h-36 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10 bg-[#121212]/85 backdrop-blur-sm rounded-full border border-white/10 m-3 group-hover:border-[#00D094]/50 transition-all duration-300">
