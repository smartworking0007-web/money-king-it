...
export default function ShopifyIndustries() {
  const fields = [
    { title: "Fashion & Apparel", icon: Shirt },
    { title: "Electronics", icon: Laptop },
    { title: "Beauty & Cosmetics", icon: Sparkles },
    { title: "Grocery Systems", icon: ShieldCheck },
    { title: "Healthcare Logistics", icon: HeartPulse },
    { title: "Furniture Spaces", icon: Armchair },
    { title: "Automotive Parts", icon: Wrench },
    { title: "Jewelry Brands", icon: Gem },
    { title: "Luxury Brands", icon: Milestone },
    { title: "B2B Wholesale", icon: Users },
  ];
        ...
        {fields.map((ind, idx) => {
          ...
          return (
            <motion.div
              ...
              className="group bg-white border border-zinc-200 p-4 rounded-xl flex flex-col justify-between hover:border-teal-500 cursor-pointer transition-all relative overflow-hidden shadow-xs min-h-max"
            >
              <div>
