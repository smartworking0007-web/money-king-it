// File Name: ShopifyServicesGrid.tsx
...
export default function ShopifyServicesGrid() {
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3.5 sm:gap-4">
          {SHOPIFY_SERVICES.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className={`${item.span} relative flex flex-col justify-between p-4 sm:p-5 rounded-xl bg-[#121212]/95 backdrop-blur-md border ${
                  item.highlight
                    ? "border-white/10 shadow-xs"
                    : "border-white/10 shadow-xs"
                } hover:border-[#00D094] hover:shadow-lg hover:shadow-[#00D094]/15 transition-all duration-300 ease-out group hover:-translate-y-1`}
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {item.highlight ? (
                    <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#00D094] text-black">
