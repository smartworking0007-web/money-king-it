  ...
  return (
    <section className="pt-32 pb-20 px-6 text-center bg-white border-b border-zinc-200">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto">
        ...
        <p className="text-zinc-600 max-w-2xl mx-auto mb-10 text-sm md:text-base leading-relaxed">At Skky Loom Digital Technology Pvt. Ltd., we believe exceptional people build exceptional technology. We are preparing a dedicated platform to showcase opportunities across Software Development, AI, Cyber Security, and more.</p>
