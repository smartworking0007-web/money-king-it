  ...
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-3xl font-black text-[#0F172A] mb-4">Exciting Opportunities Are On The Way</h2>
        <p className="text-zinc-600 max-w-xl mx-auto">We are currently building our dedicated recruitment platform. Soon you will be able to explore open positions and join our innovators.</p>
      </div>
