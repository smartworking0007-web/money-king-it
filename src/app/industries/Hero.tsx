    ...
    <section className="pt-24 pb-16 px-6 text-center">
      ...
      >
        <span className="text-teal-600 font-black mb-6 block uppercase tracking-widest text-[10px]">
          Future Technology Leaders Program
        </span>
        <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-[#0F172A] mb-8">
        ...
        <p className="text-zinc-600 mb-10 max-w-2xl mx-auto text-lg">
          ...
          through internships, recruitment, and university collaborations.
        </p>
