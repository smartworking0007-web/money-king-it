  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-4xl mx-auto p-16 bg-[#2D6A6A] rounded-3xl text-center text-white">
        ...
        <p className="mb-8 opacity-80 max-w-xl mx-auto">Be among the first to access expert articles, industry research, and business innovation strategies from Skky Loom Digital Technology Pvt. Ltd.</p>
